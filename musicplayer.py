...
two.pack(fill=X)
three = Label(root, text="Created By prajjwal , prashant and prakhar", bg="green",fg="white")
three.pack(fill=X)
...
button6 = Button(topFrame, text="Add", fg="red", command=openFile)
button6.pack(side=LEFT,padx=5,pady=20)
#-----------The status Bar--------------
